...
def gage2dss_all(output, site, sdate='1700-01-01', edate=''):
    ...
    Usage
    -----
        >>> gage2dss('dss_out.dss','08354900','2000-01-01')
    ...
    # For each , use code in URI but parameter key as pathname part.
    params = {'flow': '00060', 'stage': '00065'}
    try:
        for param in params:
            param_code = params[param]
            for alias,siteid in zip(site_alias,site_code):
                url = NWIS_URL%(siteid,sdate,edate,param_code)
...
if __name__ == "__main__":
    ...
    gage2dss_all('dss_out_all.dss', usgs_gages, sdate='2020-01-01')